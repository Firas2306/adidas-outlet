            ...
            <div className=" rounded-lg flex flex-col  justify-between">
                <div className="w-full max-w-md m-auto">
                    <form onSubmit={addProduct} className="bg-white rounded p-6" >
                        ...
                        <div className="my-3">
                            <label htmlFor="form_name" className="block text-primary mb-2">Description</label>
                            <textarea rows={3}  name="description" id="form_description" className="appearance-none normal-case border rounded w-full py-2 px-3 text-primary mb-3 leading-tight" placeholder="Enter description" ></textarea>
                        </div>
